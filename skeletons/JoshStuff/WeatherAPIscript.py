'''
Takes a string zip code as input, gets today's date and date of two weeks ago, and retrieves weather data for that location and time range.
Returns average temperature, average dew point, and longest duration of constant rain in that time range.
Uses the Open Meteo API, open-meteo.com.
'''
