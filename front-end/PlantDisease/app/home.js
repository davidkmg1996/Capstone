...
<View styles={styles.heroTitle}>
  
  </View>
  <View style={[styles.heroRow, {marginTop: "18%"}]}>
  <Pressable
    onHoverIn={() => setHovered(true)}
    onHoverOut={() => setHovered(false)}
    onPress = {() => router.replace('useSymptoms')}
    style={[styles.heroGlass, hovered && styles.heroGlassHoverA]}
  >
    <BlurView intensity={35} tint="regular" style={styles.heroBlur}>
      <Text style={styles.heroTitle}>Symptoms</Text>
    </BlurView>
  </Pressable>
  ...
  <Pressable
    ...
    onPress = {() => router.replace('usePhoto')}
    style={[styles.heroGlass, hoveredB && styles.heroGlassHoverB]}
  >
    <BlurView intensity={35} tint="regular" style={styles.heroBlur}>
      <Text style={styles.heroTitle}>Image</Text>
    </BlurView>
  </Pressable>

  <Pressable
    onHoverIn={() => setHoveredC(true)}
    onHoverOut={() => setHoveredC(false)}
    onPress = {() => router.replace('mixr')}
    style={[styles.heroGlass, hoveredC && styles.heroGlassHoverC]}
  >
    <BlurView intensity={35} tint="regular" style={styles.heroBlur}>
      <Text style={styles.heroTitle}>MiXr</Text>
    </BlurView>
  </Pressable>
</View>
