        ...
        <View>
            {
                ...
                ?
                    <TouchableOpacity style={{borderWidth:1,borderRadius:10,borderColor:'gray', marginRight: 35, paddingHorizontal:20, paddingVertical:12}} onPress={() => { if(!dropdown){ Keyboard.dismiss(); slidedown() }else{ slideup() } }} >
                        <View>
